...
[00:15.20] -> [00:18.00] { italic: true } More text with no overrides
```

- `//` starts a comment line.
- `@key: value` sets a global default, used by any cue that doesn't override that property. Valid keys: `font`, `size`, `color`, `align`.
...
- Only one cue is shown at a time — no overlapping/concurrent cues.
...
| Key | Value | Notes |
|---|---|---|
| `font` | quoted string | any font name, e.g. `"Inter"` |
